...
after creating the empty array we use a for loop to increment through the arrays length
now we call the newArr to push into the math.pow within the original array index and raise it to the third power
*/
