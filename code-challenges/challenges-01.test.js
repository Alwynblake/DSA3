...
// test('It should provide an array of strings, that get uppercased, and a "!" at the end', () => ['HELLO!', '301!', 'STUDENTS!']
...
const createList = (availableItems) => {
  // Solution code here...
  const groceryList = [];
  //iterate through inventory list , check if value of 'available' = true, if true add 'name' to groceryList array
