...
const sortStarWarsCharacters = (starWarsArr) => {
  return starWarsArr.sort((l,r) => {return r.height - l.height})
};
...
const listFoods = (recipe) => {
  let result = [];
  // const regex = /(sized )|(gallons )|(pound |pounds )|(cups )/
  // recipe.ingredients.forEach(ingredient => {
  //   result.push(
  //     ingredient.slice(ingredient.indexOf(ingredient.match(regex)))
  //     )
  //   console.log(ingredient.indexOf(regex))
  // })
  // console.log(result)
...
};//Are you paying attention? This one is pissing me off. I'll figure it out later and resubmit.
