...
const toLastNames = people => {
  ...
  // we return people and .map them to a new function called value. The value function will compare the first name and the last name  to strict equal the results
};
...
const validateWord = (word) => {
  ...
  //sorting charecters a - z in camell case and lowercase, followed by sorting words between 5 and 10
};
