...
// Props to Lydia for helping me get started
...
//   });
// });
// Three Parameters, Value, Index or an Array
...
const addOne = (arr) => { // arr is equal to addOne
  ...
  return output;// we return the value
};
// credit to Victor and James for helping
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
// I will add notes later, just too tired tonight
/* ------------------------------------------------------------------------------------------------
